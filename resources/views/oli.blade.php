...
<div class="container">
    <h1>🛢️ Koleksi Oli Motor</h1>
    <div class="search-box"><input type="text" id="searchInput" placeholder="Cari Oli..."></div>

    <div class="product-grid">
        @if($olis->isEmpty()) <p style="grid-column: 1/-1; text-align: center;">Belum ada data Oli.</p> @else
            @foreach ($olis as $o)
            <div class="product-card">
                <img src="{{ asset('img/' . ($o->gambar ? $o->gambar : 'no-image.jpg')) }}" alt="{{ $o->namaOli }}">
                ...
                <div class="action-mode-admin" style="width:100%">
                    <div class="admin-buttons-container">
                        ...
                        <form action="{{ route('produk.destroy', ['kategori' => 'oli', 'id' => $o->idOli]) }}" method="POST" onsubmit="return confirm('Hapus?');" style="flex:1;">
                            @csrf @method('DELETE')
