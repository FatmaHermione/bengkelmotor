...
<body>
  <header>
    <a href="home.html" class="ikon-kembali" title="Kembali ke Home">←</a>
    <h1>Data Pegawai</h1>
  </header>
  ...
  <main class="pegawai-container">
    <div class="pegawai-card">
      <div class="foto">
        <img src="marsya.jpeg" alt="Pegawai 1">
      </div>
      <div class="info">
        <h2>Yola Valery</h2>
    ...
    <div class="pegawai-card">
      <div class="foto">
        <img src="jcwk.jpeg" alt="Pegawai 2">
      </div>
      <div class="info">
        <h2>Rian Saputra</h2>
    ...
    <div class="pegawai-card">
      <div class="foto">
        <img src="putri.jpeg" alt="Pegawai 3">
      </div>
      <div class="info">
        <h2>Intan Ayu</h2>
